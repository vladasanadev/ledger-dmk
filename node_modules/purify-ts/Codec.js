...
const optional = (codec) => (Object.assign(Object.assign({}, (0, exports.oneOf)([codec, undefinedType])), { schema: codec.schema, _isOptional: true }));
...
const maybe = (codec) => {
    ...
    return Object.assign(Object.assign({}, baseCodec), { _isOptional: true });
};
exports.maybe = maybe;
...
const nonEmptyList = (codec) => {
    ...
    return exports.Codec.custom({
        ...
        schema: () => (Object.assign(Object.assign({}, arrayCodec.schema()), { minItems: 1 }))
    });
};
