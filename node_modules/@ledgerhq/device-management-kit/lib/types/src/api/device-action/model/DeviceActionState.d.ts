 ...
 */
export declare enum DeviceActionStatus {
...
export type DeviceActionState<Output, Error, IntermediateValue> = {
    ...
    readonly status: DeviceActionStatus.Completed;
    readonly output: Output;
} | {
    readonly status: DeviceActionStatus.Error;
    readonly error: Error;
};
//# sourceMappingURL=DeviceActionState.d.ts.map