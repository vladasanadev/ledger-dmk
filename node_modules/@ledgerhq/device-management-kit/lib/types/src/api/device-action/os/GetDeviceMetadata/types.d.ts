...
import { type GoToDashboardDAError, type GoToDashboardDAInput, type GoToDashboardDARequiredInteraction } from "../../../device-action/os/GoToDashboard/types";
import { type ListAppsDAError, type ListAppsDARequiredInteraction } from "../../../device-action/os/ListApps/types";
...
export type GetDeviceMetadataDAState = DeviceActionState<GetDeviceMetadataDAOutput, GetDeviceMetadataDAError, GetDeviceMetadataDAIntermediateValue>;
