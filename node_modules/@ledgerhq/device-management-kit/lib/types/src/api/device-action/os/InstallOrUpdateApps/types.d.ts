...
import type { OutOfMemoryDAError, UnsupportedApplicationDAError, UnsupportedFirmwareDAError } from "../../../device-action/os/Errors";
 ...
 */
export type ApplicationVersionConstraint = `${number}.${number}.${number}` | `${number}.${number}.${number}-${string}` | `${number}.${number}.${number}+${string}` | `${number}.${number}.${number}-${string}+${string}` | "latest";
...
export type InstallOrUpdateAppsDAError = GetDeviceMetadataDAError | InstallAppDAError | OutOfMemoryDAError | UnsupportedApplicationDAError | UnsupportedFirmwareDAError | SecureChannelInstallDAErrors | CommandErrorResult["error"];
...
export type InstallOrUpdateAppsDAState = DeviceActionState<InstallOrUpdateAppsDAOutput, InstallOrUpdateAppsDAError, InstallOrUpdateAppsDAIntermediateValue>;
