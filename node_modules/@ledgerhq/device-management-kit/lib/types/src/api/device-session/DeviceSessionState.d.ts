import { type GetAppAndVersionResponse } from "../command/os/GetAppAndVersionCommand";
import { type BatteryStatusFlags } from "../command/os/GetBatteryStatusCommand";
import { type GetOsVersionResponse } from "../command/os/GetOsVersionCommand";
import { type DeviceModelId } from "../device/DeviceModel";
import { type DeviceStatus } from "../device/DeviceStatus";
import { type Application } from "../../internal/manager-api/model/Application";
import { type FinalFirmware, type OsuFirmware } from "../../internal/manager-api/model/Firmware";
 ...
 */
export declare enum DeviceSessionStateType {
    Connected = 0,
 ...
 */
export type ReadyWithoutSecureChannelState = DeviceSessionBaseState & DeviceSessionReadyState & {
    /**
     * The type of the device session state.
     */
 ...
 */
export type ReadyWithSecureChannelState = DeviceSessionBaseState & DeviceSessionReadyState & {
    /**
     * The type of the device session state.
     */
 ...
 */
export type DeviceSessionState = ConnectedState | ReadyWithoutSecureChannelState | ReadyWithSecureChannelState;
export {};
//# sourceMappingURL=DeviceSessionState.d.ts.map