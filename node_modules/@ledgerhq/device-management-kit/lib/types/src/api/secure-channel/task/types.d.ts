...
export declare enum SecureChannelOperationEnum {
...
export declare enum InMessageQueryEnum {
    EXCHANGE = "exchange",
    BULK = "bulk",
    ERROR = "error",
    WARNING = "warning",
...
export declare enum OutMessageResponseEnum {
    SUCCESS = "success",
    ERROR = "error"
}
/**
 ...
 *
 */
export declare enum SecureChannelEventType {
    Opened = "opened",
    Closed = "closed",
