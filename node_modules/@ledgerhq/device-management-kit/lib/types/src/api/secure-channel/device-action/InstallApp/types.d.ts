...
import { type InstalledApp, type ListInstalledAppsDAInput, type ListInstalledAppsDAIntermediateValue } from "../../../secure-channel/device-action/ListInstalledApps/types";
...
export type InstallAppDAInput = GoToDashboardDAInput & ListInstalledAppsDAInput & {
    appName: string;
};
export type InstallAppDAError = CommandErrorResult["error"] | GoToDashboardDAError | HttpFetchApiError | SecureChannelInstallDAErrors | UnknownDAError;
export type InstallAppDARequiredInteraction = UserInteractionRequired.None | UserInteractionRequired.UnlockDevice | UserInteractionRequired.AllowSecureConnection;
export type InstallAppDAIntermediateValue = ListInstalledAppsDAIntermediateValue & {
    requiredUserInteraction: InstallAppDARequiredInteraction;
    progress: number;
    deviceId?: Uint8Array;
};
export type InstallAppDAState = DeviceActionState<InstallAppDAOutput, InstallAppDAError, InstallAppDAIntermediateValue>;
